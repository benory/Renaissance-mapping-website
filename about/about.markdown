...
<p>A 2024 <a href="https://publichumanities.stanford.edu/research-grants/humanities-seed-grants" target="_blank">Stanford Humanities Seed Grant</a> has enabled us to build our mapping tool and expand our database. At present we have more than <span id="event-count"></span> events, ranging from letters by Ferrarese scribes to French royal chapel paylists to secondary literature that describes <a href="https://renaissancemapping.org/?eventid=03288" target="_blank">how one particular singer in Bruges was fired owing to his laziness, disobediance, and downright incompetence</a>.</p>
